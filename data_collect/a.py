...
for i in range(len(from_list)):
    ...
    data.to_csv('./'+from_date+"_"+to_date+'_key.csv',encoding="utf-8-sig",index=False)
######## Get Network_List #####################
network_list=[]
for key_list in temp:
    ...
    data.to_csv('./'+key_list.from_date+'_'+key_list.to_date+'network.csv',encoding="utf-8-sig",index=False)
##
